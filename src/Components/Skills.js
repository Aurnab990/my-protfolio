...
const Skills = () => {
    return (
        <div className='lg:px-44 mt-5 lg:mt-8'>
            <h1 className='text-4xl font-senibold p-12 text-white font-sans'>My <span className='text-orange-500'>Skills</span></h1>
           ...
           <img style={{"width":"96px"}} className="mask mask-squircle bg-slate-500 transition ease-in-out delay-150 bg-white-500 hover:-translate-y-1 hover:scale-110 hover:bg-slate-500 duration-400" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/1200px-HTML5_logo_and_wordmark.svg.png" />
            <img style={{"width":"96px"}} className="mask mask-squircle bg-slate-500 transition ease-in-out delay-150 bg-white-500 hover:-translate-y-1 hover:scale-110 hover:bg-slate-500 duration-400 mb-5" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/CSS3_logo_and_wordmark.svg/1200px-CSS3_logo_and_wordmark.svg.png" />
